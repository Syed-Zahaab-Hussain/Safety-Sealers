  ...
  return (
    <div className="container mx-auto py-10 px-20">
      ...
      <div className="space-y-4">
        <p className="mb-4">
          Protection of the buildings against rising dampness from the ground is
          of utmost importance as it provides many benefits, comfort and long
          life being the most important of them. Water logged areas need special
          attention, while other new construction also requires care in view of
          changing conditions in future. We follow British code of practice No.
          CPJ 02: 1973 entitled:
        </p>
        ...
        <p>
          Underpasses in Lahore located 10 feet below the canal bed have also
          been waterproofed by us. // Specification along with list of jobs is
          enclosed.
        </p>
